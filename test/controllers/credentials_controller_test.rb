...
class CredentialsControllerTest < ActionController::TestCase
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post :create, credential: { basedir: @credential.basedir, name: @credential.name, password: @credential.password, transfer_id: @credential.transfer_id, username: @credential.username }
    end
  ...
  test "should update credential" do
    patch :update, id: @credential, credential: { basedir: @credential.basedir, name: @credential.name, password: @credential.password, transfer_id: @credential.transfer_id, username: @credential.username }
    assert_redirected_to credential_path(assigns(:credential))
  end
